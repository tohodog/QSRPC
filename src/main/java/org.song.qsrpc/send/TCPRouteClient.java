...
public class TCPRouteClient {
	...
	private static final int readTimeout = 18 * 1000;
	 ...
	 * 异步发送,nio
	 */
	public void sendAsync(Message request, Callback<Message> callback) {
		sendAsync(request, callback, readTimeout);
	}
	 ...
	 * @throws RPCException
	 */
	public Message sendSync(Message request) throws InterruptedException, RPCException {
